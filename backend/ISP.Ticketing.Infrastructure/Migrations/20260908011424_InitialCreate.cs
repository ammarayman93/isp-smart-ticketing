        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Region = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AffectedCategoryId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutageEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OutageEvents_Categories_AffectedCategoryId",
                        column: x => x.AffectedCategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictedPriority = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassificationLogs_Categories_PredictedCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerPhone = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CustomerRegion = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Title = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    TeamId = table.Column<int>(type: "int", nullable: true),
                    OutageEventId = table.Column<long>(type: "bigint", nullable: true),
                    CreatedById = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ClassifiedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ...
                    SentimentScore = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    AiConfidence = table.Column<decimal>(type: "decimal(65,30)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_OutageEvents_OutageEventId",
                        column: x => x.OutageEventId,
                        principalTable: "OutageEvents",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassificationLogs_PredictedCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutageEvents_AffectedCategoryId",
                table: "OutageEvents",
                column: "AffectedCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_OutageEventId",
                table: "Tickets",
                column: "OutageEventId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ClassificationLogs_Tickets_TicketId",
                table: "ClassificationLogs",
                column: "TicketId",
                principalTable: "Tickets",
                principalColumn: "Id",
